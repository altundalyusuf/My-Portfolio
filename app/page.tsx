    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-5 pr-3 sm:pl-20 lg:pl-24 xl:pl-40 pb-56 md:pb-20 flex flex-col items-center md:items-start gap-5 z-[10] max-w-[750px]">
          <h1 className="text-[30px] md:text-[40px] text-white font-semibold text-center md:text-left">
            Software Developer | Ex-NTT Data |
          ...
          <div className="hidden md:block">
            ...
            <p className="text-gray-200">
              I'm a{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-yellow-400 font-bold">
                Computer Engineer & Software Developer
              </span>{" "}
              with enterprise experience at NTT Data (Global), specializing in
              building scalable web and mobile applications with{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-purple-500 font-bold">
                React.js and TypeScript
              </span>
              . I am passionate about creating impactful, performant, and
              user-centric web and mobile solutions. Let's connect and build
      ...
      <div className="absolute bottom-28 xl:bottom-1/4 right-0 z-[10]">
        <div className="h-[130px] w-[130px] sm:h-[200px] sm:w-[200px] lg:h-[300px] lg:w-[300px] absolute top-16 sm:top-28 md:top-28 lg:top-40">
          <Image src="/horse.png" alt="horse" height={300} width={300} />
        </div>
